...
public class XmlTest {
	public static void main(String[] args) throws Exception {
		...
		parse.parse(Thread.currentThread()
				.getContextClassLoader().getResourceAsStream("com/zfy/context/web.xml"),hander);
		//获取数据；
		WebContext context=new WebContext(hander.getEntitys(), hander.getMappings());
		//假设你输入了/login;-->L;
		//String className=context.getClz("/login");
		//假设你输入了/regin;-->R;
		String className=context.getClz("/regin");
